...
class BaseTestCase(unittest.TestCase):
    ...
    def assertRoundTrip(
        ...
        source = [
            {
                "name": name,
                "features": [{"geometry": input_geometry, "properties": properties}],
            }
        ]
        if id:
...
class TestDifferentGeomFormats(BaseTestCase):
    ...
    def test_encoder_multipolygon_w_hole(self):
        self.assertRoundTrip(
            input_geometry="MULTIPOLYGON (((40 40, 20 45, 45 30, 40 40)), ((20 35, 10 30, 10 10, 30 5, 45 20, 20 35), "
    ...
    def test_with_wkb(self):
        self.assertRoundTrip(
            input_geometry=b"\001\003\000\000\000\001\000\000\000\005\000\000\000\000\000\000\000\000\000\000\000\000"
            b"\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\360"
            b"?\000\000\000\000\000\000\360?\000\000\000\000\000\000\360?\000\000\000\000\000\000\360"
        ...
        with self.assertRaises(NotImplementedError) as ex:
            mapbox_vector_tile.encode(
                [
                    {
                        "name": self.layer_name,
                        "features": [{"geometry": "xyz", "properties": self.feature_properties}],
                    }
                ]
            )
    ...
    def test_encode_feature_with_id(self):
        ...
        self.assertRoundTrip(
            input_geometry=geometry,
            expected_geometry={"type": "Point", "coordinates": [1, 1]},
            id=42,
        )
    ...
    def test_encode_multipolygon_normal_winding_order(self):
        geometry = (
            "MULTIPOLYGON (((40 40, 20 45, 45 30, 40 40)), ((20 35, 10 30, 10 10, 30 5, 45 20, 20 35), (30 20, "
            "20 15, 20 25, 30 20)))"
        )
        self.assertRoundTrip(
            input_geometry=geometry,
    ...
    def test_encode_multipolygon_normal_winding_order_zero_area(self):
        geometry = (
            "MULTIPOLYGON (((40 40, 40 20, 40 45, 40 40)), ((20 35, 10 30, 10 10, 30 5, 45 20, 20 35), (30 20, "
            "20 15, 20 25, 30 20)))"
        )
...
class InvalidGeometryTest(unittest.TestCase):
    ...
    def test_geometry_collection_raises(self):
        ...
        collection = shapely.wkt.loads(
            "GEOMETRYCOLLECTION (GEOMETRYCOLLECTION (POINT (4095 3664), LINESTRING (2889 0, 2889 0)), POINT (4095 "
            "3664), LINESTRING (2889 0, 2912 158, 3757 1700, 3732 1999, 4095 3277))"
        )
    ...
    def test_quantize_makes_mutlipolygon_invalid(self):
        ...
        shape = shapely.wkt.loads(
            "MULTIPOLYGON (((656510.8206577231 5674684.979891453, 656511.16 5674685.9, 656514.1758819892 "
            "5674684.979891453, 656510.8206577231 5674684.979891453)), ((657115.9120547654 5674684.979891453, "
            "657118.85 5674690, 657118.0689111941 5674684.979891453, 657115.9120547654 5674684.979891453)))"
        )
        quantize_bounds = (
            645740.0149532147,
            5674684.979891453,
